...
<template>
  <div class="bg-secondary h-0.5"></div>  
    <footer class="bg-deepBlue py-4 text-secondary">  
      <div class="bg-deepBlue p-4 flex flex-col sm:flex-row items-center justify-between">
        ...
        <p class="text-gray-200 mb-4 sm:mb-0">&copy; 2024 Sofiane Mouadeb. Site sur la cybersécurité.</p>
        <div class="flex justify-center sm:justify-end space-x-8 sm:space-x-4">
          <RouterLink to="/login-logout" class="text-deepBlue hover:text-deepBlue">Se connecter</RouterLink>
